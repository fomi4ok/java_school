...
import ru.stqa.school.mantis.model.Issue;
import ru.stqa.school.mantis.model.Project;
...
public class SoapHelper {
  ...
  public MantisConnectPortType getMantisConnect() throws ServiceException, MalformedURLException {
    return new MantisConnectLocator()
              .getMantisConnectPort(new URL("http://localhost/mantisbt-2.9.0/api/soap/mantisconnect.php"));
  }
